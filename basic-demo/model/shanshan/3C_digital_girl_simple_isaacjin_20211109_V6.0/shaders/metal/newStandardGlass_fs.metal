...
fragment xlatMtlShaderOutput newStandardGlass_fs (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(1)]]
  ...
  ,   texture2d<float> emissivetex [[texture(6)]], sampler _mtlsmp_emissivetex [[sampler(6)]])
{
  ...
  tmpvar_46 = min (((
   ...
   +
    dot (tmpvar_29, (float3)float3(0.2125, 0.7154, 0.0721))
