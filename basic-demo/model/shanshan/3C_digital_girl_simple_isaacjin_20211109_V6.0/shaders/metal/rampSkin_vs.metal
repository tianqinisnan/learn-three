...
vertex xlatMtlShaderOutput rampSkin_vs (xlatMtlShaderInput _mtl_i [[stage_in]], constant xlatMtlShaderUniform& _mtl_u [[buffer(1)]])
{
  ...
  _mtl_o.v_UV3 = ((_mtl_i.inTexCoord0 * _mtl_u.masktex_uv.xy) + _mtl_u.masktex_uv.zw);
  float4 tmpvar_2;
  tmpvar_2.w = 0.0;
  ...
  _mtl_o.v_wView = normalize((_mtl_u._CameraPos - (_mtl_u._M * tmpvar_5).xyz));
